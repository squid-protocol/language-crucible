...
The commit above is the exact `HEAD` of the pool clone at the moment these
files were copied (2026-08-28) — note the clone itself is from 2021-07-26,
notably older than most other pool clones used in this corpus; that's simply
how old that particular checkout is, not a data-quality signal.
