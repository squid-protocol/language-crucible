...
|---|---|---|---|---|---|
| `freebsd` | 2 | unknown | unknown | BSD License | No confidently-matched pool clone found. Local license file detected (COPYRIGHT). |

**Total: 2 files across 1 repo folder(s)** (1 unknown).
