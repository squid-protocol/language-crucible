...
//            PARM=(NODYNAM,RENT,LIST,MAP,XREF,
//   'APOST,TRUNC(OPT),NOCICS,TEST(SEPARATE(DSNAME),SOURCE),ADATA')
...
//         DD DISP=SHR,DSN=&LEHLQ..SCEESAMP
//SYSDEBUG DD DISP=SHR,DSN=&CBSAHLQ..DEBUG(&MEMBER)
//SYSADATA DD DISP=SHR,DSN=&CBSAHLQ..ADATA(&MEMBER)
//DBRMLIB   DD DISP=SHR,
